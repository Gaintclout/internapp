...
export default function Spamshield() {
  ...
  const handleFileSave = async (fileType) => {
    try {
      const fileData = {
        fileName: fileType === "spamshieldX.pdf",
        fileType: fileType,
   ...
   return (
      ...
      >
       ...
       <p className="text-gray-600 leading-relaxed">
          “Spamshield” refers to advanced systems that detect and block spam,
          phishing, and fraudulent activity. It is used in telecom networks,
          messaging apps, social media platforms, and email systems. AI
          algorithms analyze messages in real time to prevent scams, malicious
